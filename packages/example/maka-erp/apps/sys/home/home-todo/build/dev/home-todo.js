...
external_maka_["fetch"].mock('/v1/home/todo', function (option) {
  initMockData();
  return {
    result: true,
...
var index_action = (_dec = Object(external_maka_["actionMixin"])('base', 'moment', 'tableHelper'), _dec(_class = function action(option) {
  var _this = this;
    ...
    return regenerator_default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return external_maka_["fetch"].post('/v1/home/todo', {});
