...
var action_action = (_dec = Object(external_maka_["actionMixin"])('base', 'tableHelper'), _dec(_class2 = function action(option) {
  var _this = this;
    ...
    return regenerator_default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return external_maka_["fetch"].post('/v1/dashboard/hot/search', {});
  ...
  defineProperty_default()(this, "getChartOption", function (data) {
    console.log(data);
    return {
      tooltip: {
        trigger: 'axis'
...
external_maka_["fetch"].mock('/v1/dashboard/hot/search', function (option) {
  initMockData();
  return {
    result: true,
