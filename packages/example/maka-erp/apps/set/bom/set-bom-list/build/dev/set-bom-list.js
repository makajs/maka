...
module.exports = {"isMakaApp":true,"name":"set-bom-list","description":"set-bom-list","version":"1.0.0","license":"MIT","author":"","repository":{"type":"git","url":"https://github.com/makajs/maka.git"},"bugs":{"url":"https://github.com/makajs/maka/issues"},"homepage":"https://github.com/makajs/maka#readme","scripts":{"start":"maka start","dev":"maka start --dev","build":"maka build","pkg":"maka pkg"},"dependencies":{},"server":{"proxy":null,"port":8000},"subAppDir":["./apps","../../../base","../set-bom"]};
...
var external_maka_ = __webpack_require__(2);
...
var action_action = (_dec = Object(external_maka_["actionMixin"])('base', 'lodash', 'moment', 'tableHelper', 'modal', 'message'), _dec(_class2 = function action(option) {
  var _this = this;
  ...
  function () {
    ...
    /*#__PURE__*/
    regenerator_default.a.mark(function _callee(pagination) {
      var filter,
          resp,
          _args = arguments;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return external_maka_["fetch"].post('/v1/bom/query', {
            ...
            case 3:
              resp = _context.sent;
              if (!resp.pagination) resp.pagination = pagination;
              resp.filter = filter;
              resp.filter.search = _this.base.gs('data.filter.search');
    ...
    return regenerator_default.a.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _this.component.props.setPortalContent && _this.component.props.setPortalContent('新增BOM', 'set-bom');
        ...
        return regenerator_default.a.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _this.component.props.setPortalContent && _this.component.props.setPortalContent('BOM维护', 'set-bom', {
                  bomId: row.id
                });
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 5:
                id = row.id;
                _context5.next = 8;
                return external_maka_["fetch"].post('/v1/bom/del', {
                  boms: [{
                    id: id
                  }]
                });
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _this.message.error('请选中要删除的BOM');
          ...
          case 13:
            boms = selectRows.map(function (o) {
              return {
                id: o.id
              };
            });
...
external_maka_["fetch"].mock('/v1/bom/query', function (option) {
  initMockData();
...
external_maka_["fetch"].mock('/v1/bom/del', function (option) {
  initMockData();
