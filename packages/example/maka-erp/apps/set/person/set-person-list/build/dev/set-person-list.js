(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["MakaApp-set-person-list"] = factory(require("maka"));
	else
		root["MakaApp-set-person-list"] = factory(root["maka"]);
...
var action_action = (_dec = Object(external_maka_["actionMixin"])('base', 'lodash', 'moment', 'tableHelper', 'modal', 'message'), _dec(_class2 = function action(option) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return external_maka_["fetch"].post('/v1/person/query', {
        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return _this.modal.show({
              title: '新增人员',
              children: Object(external_maka_["createAppElement"])('set-person', {}),
              width: 500,
              bodyStyle: {
                height: 300
              }
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 5:
                id = row.id;
                _context5.next = 8;
                return external_maka_["fetch"].post('/v1/person/del', {
                  persons: [{
                    id: id
                  }]
                });
  ...
  regenerator_default.a.mark(function _callee6() {
    var lst, selectRows, ret, persons;
    return regenerator_default.a.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 13:
            persons = selectRows.map(function (o) {
              return {
                id: o.id
              };
            });
