...
module.exports = {"isMakaApp":true,"name":"set-person","description":"set-person","version":"1.0.0","license":"MIT","author":"","repository":{"type":"git","url":"https://github.com/makajs/set-person.git"},"bugs":{"url":"https://github.com/makajs/set-person/issues"},"homepage":"https://github.com/makajs/set-person#readme","scripts":{"start":"maka start","dev":"maka start --dev","build":"maka build","pkg":"maka pkg"},"dependencies":{},"server":{"proxy":null,"port":8000},"subAppDir":["./apps","../../../base"]};
...
/* harmony default export */ var view = ({
  ...
  children: {
    ...
    children: [{
      ...
      title: '性别',
      required: true,
      bindPath: 'data.form.sex',
      onLoadOption: '{{$loadSex}}'
    }, {
      type: 'datePicker',
      title: '生日',
      required: true,
      bindPath: 'data.form.birthday'
    }, {
      type: 'number',
      title: '手机',
      required: true,
...
var action_action = (_dec = Object(external_maka_["actionMixin"])('base', 'lodash', 'moment', 'modal', 'message'), _dec(_class2 = function action(option) {
  var _this = this;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return external_maka_["fetch"].post('/v1/person/findById', {
              id: _this.component.props.personId
            });
  ...
  defineProperty_default()(this, "onOk",
  /*#__PURE__*/
  asyncToGenerator_default()(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 5:
            ...
            _context3.next = 9;
            return external_maka_["fetch"].post('/v1/person/update', form);
          ...
          case 12:
            _context3.next = 14;
            return external_maka_["fetch"].post('/v1/person/create', form);
          ...
          case 15:
            ...
            _this.message.success(isModify ? '修改人员成功' : '新增人员成功');
  ...
  defineProperty_default()(this, "checkSave", function (form) {
    var msg = [];
  ...
  defineProperty_default()(this, "loadDepartment",
  /*#__PURE__*/
  asyncToGenerator_default()(
  /*#__PURE__*/
  ...
  if (!mockData.persons) {
    ...
    for (var _i = 0; _i < 200; _i++) {
      mockData.persons.push({
        ...
        birthday: "1980-".concat(_i % 11 + 1, "-").concat(_i % 28 + 1),
        mobile: '13818181' + (100 + _i),
...
external_maka_["fetch"].mock('/v1/person/query', function (option) {
  initMockData();
...
external_maka_["fetch"].mock('/v1/person/del', function (option) {
  initMockData();
...
external_maka_["fetch"].mock('/v1/person/findById', function (option) {
  initMockData();
...
external_maka_["fetch"].mock('/v1/person/create', function (option) {
  initMockData();
...
external_maka_["fetch"].mock('/v1/department/queryAll', function (option) {
  initMockData();
  return {
    result: true,
