export default {
    ...
    children: {
        component: 'tpl.Form',
        children: [
            { type: 'select', title: '客户组', required: true, bindPath: 'data.form.customerGroup', showSearch:true,
            onLoadOption: '{{$loadCustomerGroup}}',   onChange: `{{(v)=>{console.log(v);debugger;$base.setState({'data.form.customerGroup': v })}}}`, },
