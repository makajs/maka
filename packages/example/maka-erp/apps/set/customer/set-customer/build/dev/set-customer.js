      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return external_maka_["fetch"].post('/v1/customer/findById', {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 5:
            ...
            _context3.next = 9;
            return external_maka_["fetch"].post('/v1/customer/update', form);
          ...
          case 12:
            _context3.next = 14;
            return external_maka_["fetch"].post('/v1/customer/create', form);
...
external_maka_["fetch"].mock('/v1/customer/findById', function (option) {
  initMockData();
...
external_maka_["fetch"].mock('/v1/customer/create', function (option) {
  initMockData();
...
external_maka_["fetch"].mock('/v1/customer/gourp/queryAll', function (option) {
  initMockData();
  return {
    result: true,
