(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["MakaApp-set-customer-list"] = factory(require("maka"));
	else
		root["MakaApp-set-customer-list"] = factory(root["maka"]);
...
var action_action = (_dec = Object(external_maka_["actionMixin"])('base', 'lodash', 'moment', 'tableHelper', 'treeHelper', 'modal', 'message'), _dec(_class2 = function action(option) {
  ...
  function () {
    ...
    /*#__PURE__*/
    regenerator_default.a.mark(function _callee(type, pagination) {
      var filter,
          tree,
          list,
          customers,
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.t0 = type;
              _context.next = _context.t0 === 'all' ? 4 : _context.t0 === 'list' ? 17 : _context.t0 === 'tree' ? 23 : 31;
              break;

            case 4:
              _context.next = 6;
              return external_maka_["fetch"].post('/v1/customer/group/queryAll', {});
            ...
            case 9:
              tree = _context.t1;
              tree = _this.treeHelper.build(tree);
              _context.next = 13;
              return external_maka_["fetch"].post('/v1/customer/query', {
            ...
            case 31:
              filter.search = _this.base.gs('data.filter.search');
              json = {};

              if (tree) {
                json = objectSpread_default()({}, json, {
                  'data.tree': tree
                });
              }
  ...
  defineProperty_default()(this, "treeReload", function () {
    _this.load('tree');
  });

  defineProperty_default()(this, "treeSelect", function (selectedKeys, info) {
    var pagination = {
      current: 1,
      total: 0,
      pageSize: 20
        ...
        filter = {
      customerGroupId: selectedKeys[0]
    };

    _this.load('list', pagination, filter);
  });

  defineProperty_default()(this, "treeAdd",
  /*#__PURE__*/
  asyncToGenerator_default()(
  /*#__PURE__*/
  regenerator_default.a.mark(function _callee2() {
    var data, customerGroupId, tree, customerGroup, ret;
    return regenerator_default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            data = _this.base.gs();
            customerGroupId = data.filter.customerGroupId, tree = data.tree, customerGroup = tree && _this.treeHelper.findById(tree, customerGroupId);
            _context2.next = 4;
            return _this.modal.show({
              title: '新增',
              children: Object(external_maka_["createAppElement"])('set-customer-group', {
  ...
  defineProperty_default()(this, "treeModify",
  /*#__PURE__*/
  asyncToGenerator_default()(
  /*#__PURE__*/
  regenerator_default.a.mark(function _callee3() {
    var data, customerGroupId, ret;
    return regenerator_default.a.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            data = _this.base.gs();
            customerGroupId = data.filter.customerGroupId;
  ...
  defineProperty_default()(this, "treeDel",
  /*#__PURE__*/
  asyncToGenerator_default()(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 7:
            ...
            _context4.next = 11;
            return external_maka_["fetch"].post('/v1/customer/group/del', {
              id: customerGroupId
            });

          case 11:
            _this.message.success('删除客户组成功');
  ...
  defineProperty_default()(this, "reload",
  /*#__PURE__*/
  asyncToGenerator_default()(
  /*#__PURE__*/
    ...
    return regenerator_default.a.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            pagination = _this.base.gs('data.pagination'), filter = _this.base.gs('data.filter');
  ...
  defineProperty_default()(this, "pageChanged", function (current, pageSize) {
    var filter = _this.base.gs('data.filter');
  ...
  defineProperty_default()(this, "searchChange", function (e) {
    var v = e.target.value;

    _this.base.setState({
      'data.filter.search': v
    });

    _this.searchReload(v);
  });

  defineProperty_default()(this, "searchReload", function (v) {
    var pagination = _this.base.gs('data.pagination'),
        filter = _this.base.gs('data.filter');
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            return _this.modal.show({
              title: '新增客户',
              children: Object(external_maka_["createAppElement"])('set-customer', {}),
              width: 500,
              bodyStyle: {
                height: 200
              }
  ...
  defineProperty_default()(this, "modify", function (row) {
    return (
      /*#__PURE__*/
      asyncToGenerator_default()(
      /*#__PURE__*/
  ...
  defineProperty_default()(this, "del", function (row) {
    return (
      /*#__PURE__*/
      asyncToGenerator_default()(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 5:
                id = row.id;
                _context8.next = 8;
                return external_maka_["fetch"].post('/v1/customer/del', {
                  customers: [{
                    id: id
                  }]
                });
  ...
  defineProperty_default()(this, "batchDel",
  /*#__PURE__*/
  asyncToGenerator_default()(
  /*#__PURE__*/
  regenerator_default.a.mark(function _callee9() {
    var lst, selectRows, ret, customers;
    return regenerator_default.a.wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            lst = _this.base.gs('data.list');
            ...
            _this.message.error('请选中要删除的客户');

            return _context9.abrupt("return");

          case 4:
            selectRows = lst.filter(function (o) {
              return o.isSelected;
            });
          ...
          case 13:
            customers = selectRows.map(function (o) {
              return {
                id: o.id
              };
            });
...
external_maka_["fetch"].mock('/v1/customer/group/queryAll', function (option) {
  initMockData();
  return {
    result: true,
...
external_maka_["fetch"].mock('/v1/customer/query', function (option) {
  initMockData();
...
external_maka_["fetch"].mock('/v1/customer/del', function (option) {
  initMockData();
...
external_maka_["fetch"].mock('/v1/customer/group/del', function (option) {
  initMockData();
