export default {
    data: {
        ...
        "basicProgress": [{
            ...
            "key": "3", "time": "2017-10-01 13:05", "rate": "取货员接单", "status": "success", "operator": "取货员 ID1234", "cost": "5mins"
        }, {
            "key": "4", "time": "2017-10-01 13:00", "rate": "申请审批通过", "status": "success", "operator": "系统", "cost": "1h"
        }, {
            "key": "5", "time": "2017-10-01 12:00", "rate": "发起退货申请", "status": "success", "operator": "用户", "cost": "5mins"
        }]
    }
}