...
var action_action = (_dec = Object(external_maka_["actionMixin"])('base', 'toast', 'numberHelper'), _dec(_class2 = function action(option) {
    ...
    return regenerator_default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return external_maka_["fetch"].post('/v1/rpt', {});
  ...
  defineProperty_default()(this, "getColors", function () {
...
var lodash = Object(external_maka_["getAction"])('lodash');
...
external_maka_["fetch"].mock('/v1/rpt', function (option) {
  initMockData();
