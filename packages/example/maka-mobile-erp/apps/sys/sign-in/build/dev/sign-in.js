...
var action_action = (_dec = Object(external_maka_["actionMixin"])('base', 'toast'), _dec(_class2 = function action(option) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            external_maka_["navigate"].redirect('/portal');
  ...
  defineProperty_default()(this, "check", function (form) {
    var msg = [];
  ...
  defineProperty_default()(this, "goRegister", function () {
    _this.toast.info('未实现');
  });

  defineProperty_default()(this, "goForgetPassword", function () {
    _this.toast.info('未实现');
  });
