...
var action_action = (_dec = Object(external_maka_["actionMixin"])('base', 'toast', 'numberHelper'), _dec(_class2 = function action(option) {
    ...
    return regenerator_default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return external_maka_["fetch"].post('/v1/home', {});
  ...
  defineProperty_default()(this, "openList", function (item) {
    return (
      /*#__PURE__*/
      asyncToGenerator_default()(
      /*#__PURE__*/
  ...
  defineProperty_default()(this, "openTodoList", function () {
    _this.toast.info('未实现');
  });

  defineProperty_default()(this, "openToAuditList", function () {
    _this.toast.info('未实现');
  });
...
external_maka_["fetch"].mock('/v1/home', function (option) {
  initMockData();
  return {
    result: true,
    value: {
